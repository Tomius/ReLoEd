...
vec3 Glow() {
  vec3 sum = luminance_sqr(neighbours[0])
           + luminance_sqr(neighbours[1]) * 2
           + luminance_sqr(neighbours[2])
           + luminance_sqr(neighbours[3]) * 2
           + luminance_sqr(neighbours[4]) * 4
           + luminance_sqr(neighbours[5]) * 2
           + luminance_sqr(neighbours[6])
           + luminance_sqr(neighbours[7]) * 2
           + luminance_sqr(neighbours[8]);
